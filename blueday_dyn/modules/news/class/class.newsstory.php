	...
	*/
	...
	function prepare2show($filescount)
	{
		...
		if($filescount>0) {
			...
			$story['attached_link']="<a href='".XOOPS_URL.'/modules/news/article.php?storyid='.$this->storyid()."' title='"._NW_ATTACHEDLIB."'><img src='".XOOPS_URL.'/modules/news/images/attach.png'."' title='"._NW_ATTACHEDLIB."'></a>";
		} else {
