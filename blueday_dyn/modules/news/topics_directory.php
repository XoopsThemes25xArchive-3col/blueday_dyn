...
if(is_array($topics_arr) && count($topics_arr))	{
	foreach ($topics_arr as $onetopic) {
		...
		$tbl_topics[] = array('id'=>$onetopic['topic_id'], 'news_count'=>$count, 'topic_color'=>'#'.$onetopic['topic_color'], 'prefix'=>$onetopic['prefix'], 'title'=>$myts->displayTarea($onetopic['topic_title']), 'topic_imgurl' =>$myts->displayTarea($onetopic['topic_imgurl']));
	}
}
