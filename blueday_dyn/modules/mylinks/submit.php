<?php
// $Id: submit.php,v 1.1 2004/01/29 14:45:56 buennagel Exp $
//  ------------------------------------------------------------------------ //
...
// Hack SecurityImage by Kraven30
	...
	$xoopsTpl->assign('xoops_pagetitle', $myts->makeTboxData4Show($xoopsModule->name()) . ' - ' . $myts->makeTboxData4Show(_MD_SUBMITLINK));
	$xoopsTpl->assign('xoops_meta_description', $myts->makeTboxData4Show($xoopsModule->name()) . ' - ' . $myts->makeTboxData4Show(_MD_SUBMITLINK));
