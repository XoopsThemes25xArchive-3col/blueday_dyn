...
// Hack SecurityImage by Kraven30
	...
	if ( defined('SECURITYIMAGE_INCLUDED') && !SecurityImage::CheckSecurityImage() ) {
		redirect_header( 'index.php' , 1, _SECURITYIMAGE_ERROR ) ;
	}
// Hack SecurityImage by Kraven30
	...
	ob_start();
	// Allongement de la zone de texte du formulaire de soumission
  xoopsCodeTarea("message",70,8);
  ...
  ob_start();
	...
	xoops_create_page_title(_MD_SUBMITCATHEAD);
	xoops_create_meta_description($xoopsModule->name().' - '._MD_SUBMITCATHEAD);
	// End Hack
