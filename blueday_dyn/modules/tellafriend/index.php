...
if( ! is_object( $xoopsUser ) ) {
	$fromname_text = new XoopsFormText( _MI_TELLAFRIEND_FORMTHFROMNAME , "fromName" , 60 , 100 , '' ) ;
	$fromemail_text = new XoopsFormText( _MI_TELLAFRIEND_FORMTHFROMEMAIL , "fromEmail" , 60 , 100 , '' ) ;
	$_SESSION['usersSubject'] = $subject ;
	$subject_text = new XoopsFormLabel( _MI_TELLAFRIEND_FORMTHSUBJ , $subject4show ) ;
} else {
	$subject_text = new XoopsFormText( _MI_TELLAFRIEND_FORMTHSUBJ , "usersSubject", 60, 100 , $subject4show ) ;
}

$to_text = new XoopsFormText( _MI_TELLAFRIEND_FORMTHTO , "usersTo", 60, 100, '');
...
$comment_textarea = new XoopsFormTextArea( _MI_TELLAFRIEND_FORMTHBODY , "usersComments", $comment4show , 10 , 80 ) ;
