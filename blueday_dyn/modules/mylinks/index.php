...
while($myrow = $xoopsDB->fetchArray($result)) {
	...
	$content.=$myts->makeTboxData4Show($myrow['title']).' ';
	$count++;
}
...
include_once XOOPS_ROOT_PATH . '/modules/mylinks/include/functions.php';
$xoopsTpl->assign('xoops_pagetitle', $myts->makeTboxData4Show($xoopsModule->getVar('name')));
$xoopsTpl->assign('xoops_meta_keywords', mylinks_extract_keywords($content));
$xoopsTpl->assign('xoops_meta_description', $myts->makeTboxData4Show($xoopsModule->getVar('name')));
